...
class Day01Page extends StatefulWidget {
  final String title;
  final int index;

  const Day01Page({super.key, required this.title, required this.index});

  @override
  _Day01PageState createState() => _Day01PageState();
}

class _Day01PageState extends State<Day01Page> {
