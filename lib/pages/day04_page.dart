...
class Day04Page extends StatefulWidget {
  final String title;
  final int index;

  const Day04Page({super.key, required this.title, required this.index});

  @override
  _Day04PageState createState() => _Day04PageState();
}

class _Day04PageState extends State<Day04Page> {
